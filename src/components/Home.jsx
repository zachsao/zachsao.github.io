      ...
      <div className="container hero__grid">
        <div className="hero__content">
          ...
          <h1 className="hero__title">
            Hi, I'm{" "}
            <span className="hero__title-accent">Zacharia</span>
            {" "}👋
          </h1>

          <p className="hero__subtitle">
            Software developer specializing in Android — six years building apps
            for startups and big tech, based in Montreal.
          </p>
        ...
        <div className="hero__visual">
          <div className="hero__image-ring">
            <div className="hero__image-wrap">
              <img src={profilePicture} alt="Zacharia Sao" />
            </div>
          </div>
          <div className="hero__float-card hero__float-card--1">
            <span>6+</span> years experience
          </div>
